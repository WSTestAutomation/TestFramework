...
class Navigation_business(BusinessWebPage):
    ...
    def __init__(self, driver):
        ...
        self.menu = {
            ...
            'Stream Migration':self.Admin_settings_menu_item(name="Manage Stream", obj=self, has_subitems=True, parent=None, is_clickable=True, by=self._page.streammigration_button, tab_by=None),
